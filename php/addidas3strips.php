...
<div class="container store">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="../img/addidas1.png" alt="Addidas 3 Strips">
    </div>

    <div class="item">
      <img src="../img/addidas2.png" alt="Addidas 3 Strips">
    </div>
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <div class="col-sm-6">
      <div class="row">
        ...
        <h2>Adidas 3 Strips</h2>
        <span class="fa fa-star checked"></span>
        <span class="fa fa-star checked"></span>
        <span class="fa fa-star checked"></span>
        <span class="fa fa-star"></span>
        <span class="fa fa-star"></span>
        <p>Product Code: ISAS2020<P>
        <p class="price">GBP £79.00<p>
